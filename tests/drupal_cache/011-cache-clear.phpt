...
<?php
    ...
    if (serialize(array_keys($result)) == serialize(array('llave1', 'llave2', 'llave3'))
        && serialize(array_values($keys)) == serialize(array('key1', 'key2', 'key3', 'key4', 'llave4'))) {
        print "Looks good.\n";
    }
?>
--EXPECT--

--TEST--
Clear: $cache->clear() with wildcards on a variety of expirations.
--FILE--
<?php
    ...
    $cache->set('node:mixed',   'node7!', 0);
    $cache->set('node:mixed:1', 'node8!', -1);
    $cache->set('node:mixed:2', 'node9!', REQUEST_TIME + 60);
